// File: app/(auth)/dealer/login/page.tsx
"use client";
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="dealer@tvscredit.com"
                />
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 grid grid-cols-1 gap-3">
                <Link
                  ...
                  className="w-full flex justify-center py-2 px-4 border border-gray-700 rounded-lg shadow-sm text-sm font-medium text-gray-300 bg-gray-800/50 hover:bg-gray-700/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 transition-colors"
                >
                  Register as Dealer
                </Link>
              </div>
